    ...
    def failure_recovery(self, fail_info):
        ...
        for proj in projs:
            ...
            try:
                ...
                self.cfg.dcnm.default_partition_name, proj.dci_id)
        ...
        for net in nets:
            if net.result == constants.CREATE_FAIL:
                ...
                subnets = self.neutron_event.nclient.list_subnets(network_id=
                                                      net_id).get('subnets')
                for subnet in subnets:
                    ...
                    try:
                        ...
                        params = dict(columns=
                                      dict(config_profile=net.config_profile,
                                           fwd_mod=net.fwd_mod,
        ...
        for vm in instances:
            ...
            if vm.result == constants.CREATE_FAIL:
                try:
                    ...
                    params = dict(columns=dict(result=
